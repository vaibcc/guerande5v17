      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="shrink-0">
            ...
            e="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.25em] text-amber-400 mb-3">
            ...
            <p className="mt-3 text-sm md:text-base text-white/60 leading-relaxed">
              Guérande 5 participe aux compétitions dans le cadre de la
              Fédération Française de Billard.
            </p>
          </div>
        </motion.div>
